export const bioInfo = {
  ...
  fr: {
    ...
    applied:
      "Avez-vous demandé d'autres subventions à d'autres fondations?",
    yes: "Oui",
    no: "Non",
    ifYes:
    ...
    idScan:
      "ID Scan… ..Choisissez le fichier",
    programme:
      "Comment avez-vous entendu parler du programme TEF?",
  ...
  pt: {
    ...
    applied: "Você já se candidatou a outros subsídios de outras fundações?",
    yes: "Sim",
    no: "Não",
    ifYes:
