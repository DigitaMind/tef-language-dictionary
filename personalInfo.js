export const bioInfo = {
  ...
  ar: {
    ...
    applied: "هل تقدموا بطلبات للحصول على منح أخرى من مؤسسات أخرى؟",
    yes: "نعم",
    no: "لا.",
    ifYes: "إذا كانت الإجابة نعم، فاذكر اسم المؤسسة (المؤسسات) التي تقدمت بطلب منها سابقًا",
    typeOfId: "نوع المعرف ",
    ...
    message2:
      "سنحبّك أن تقوم بضم معلمك إلى منصة TEF لمساعدتك في تنمية أعمالك.",
