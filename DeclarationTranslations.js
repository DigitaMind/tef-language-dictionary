export const DeclarationTranslations = {
  ...
  fr: {
    ...
    twelve:
      "Êtes-vous un fonctionnaire actuel ou ancien d'aucune société liée a Tony Elumelu Foundation?",
  ...
  ar: {
    ...
    two: "هل تلقيت رساميل أولية من برنامج TEFConnect في الدورات السابقة؟ ?",
    twoSub: "إذا كانت الإجابة 'نعم'، أي سنة (سنوات)؟.",
    three: "هل لديك شركاء أعمال أو متعاونون من ألومنوس من البرنامج؟.",
    four: "هل أنت شخص خاضع للعقوبات أو / شريك عمل لـ / أو قريب/أو صديقمن شخص أو مجموعة خاضعة للعقوبات؟ (معنى العقوبة: التدابير العقابية أو التقييدية المفروضة على بلد أو شخص أو شركة).",
    five: "هل تتعامل أنت أو شريكك التجاري أو شركتك بشكل مباشر/غير مباشر مع دولة خاضعة للعقوبات أو شخص/مجموعة خاضعة للعقوبات؟.",
    six: "هل أنت شخص معرض لمخاطر سياسية سياسية أو قريب/صديق مقرب من شخص معرض لمخاطر سياسيةشخص يعني: شخص شغل منصباً عاماً/سياسياً بارزاً أو أبدى اهتماماً علناً بمنصب عام/سياسي بارز).",
    seven: "هل تم التحقيق معك أو مع شريك (شركاء) عملك أو توقيفك أو معاقبتهم على أي جريمة أو تهم مرتبطة بالإرهاب؟",
    eight: "",
    nine: "",
    ten: "",
    eleven: "هل تعمل مع أي من موظفي مؤسسة TEF أو موظفي أي شركة تابعة لها (شركات تابعة لشركة TEF تعني: هل تشمل أي شركة في محفظة استثمار الورثة القابضة)؟.",
    twelve: "هل أنت موظف حالي أو سابق في أي شركة تابعة لـ TEF؟ ",
    button: "تقديم استمارة التقديم",
    preview: "معاينة المعلومات الخاصة بك",
    yes: "نعم",
    no: ".لا",
    thirteen: "هل تم استجوابك أنت أو شريكك (شركاؤك) في العمل أو توقيفهم أو معاقبتهم على أي تهم تتعلق بالإرهاب",
    fourteen: "هل تم استجوابك أنت أو شريكك (شركاؤك) في العمل أو توقيفهم أو معاقبتهم على أي جريمة مالية",
    fifteen: "هل سبق لك أن خضعت أنت أو شريكك (شركاؤك) في العمل للتحقيق أو القبض عليك أو إدانتك بأي جريمة؟",
  }
};
